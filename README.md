...
dotnet sln Searchfight.sln add Searchfight.
Core\Searchfight.Core.csproj
...
dotnet sln Searchfight.sln add Searchfight.UnitTests\Searchfight.UnitTests.csproj 
...
dotnet add ./Searchfight.UnitTests/Searchfight.UnitTests.csproj package xunit.runner.console 
--version 2.4.1
